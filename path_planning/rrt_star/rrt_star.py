...
class RRTStar(RRT):
    ...
    def __init__(self, start, goal, ob_list, rand_area, expand_dis=1.0,
                path_resolution=0.5, goal_sample_rate=20, max_iter=500,
                connect_circle_dist=50.0, search_until_max_iter=False):
        '''
        start       Start Position [x,y]
        goal        Goal Position [x,y]
        ob_list     Obstacle Positions [[x,y,size],...]
        rand_area   Random Sampling Area [min,max]
        '''
        
        super().__init__(start, goal, ob_list, rand_area, expand_dis,
